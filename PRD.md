...
### 1. Product Overview
**Product Name:** ProjectCamp Backend  
**Version:** 1.0.0  
**Product Type:** Backend API for Project Management System  

ProjectCamp Backend is a RESTful API service designed to support collaborative project management. The system enables teams to organize projects, manage tasks with subtasks, maintain project notes, and handle user authentication with role-based access control.
...
- `GET /:projectId/:taskId` - Get task details (secured, role-based)  
- `PUT /:projectId/:taskId` - Update task (secured, Admin/Project Admin)  
- `DELETE /:projectId/:taskId` - Delete task (secured, Admin/Project Admin)  
...
- `GET /:projectId/:noteId` - Get note details (secured, role-based)  
- `PUT /:projectId/:noteId` - Update note (secured, Admin only)  
- `DELETE /:projectId/:noteId` - Delete note (secured, Admin only)  
...
- Stable project/task management features  
- Proper enforcement of role-based permissions  
- Reliable file and note management  
