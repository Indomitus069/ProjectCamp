        ...
        <div className="space-y-5 max-w-6xl mx-auto text-zinc-900 dark:text-white">
            ...
            <div className="flex max-md:flex-col gap-4 flex-wrap items-start justify-between max-w-6xl">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className={`px-2 py-1 rounded text-xs capitalize ${statusColors[project.status] || statusColors.PLANNING}`} >
            ...
            <div className="grid grid-cols-2 sm:flex flex-wrap gap-6">
                {[
                    ...
                    { label: "Team Members", value: (project.members || []).length, color: "text-blue-700 dark:text-blue-400" },
                ].map((card, idx) => (
